/*
  ...
  Author: 
  Date: 04/11/07 21:15
  Description: Contar nodos con exactamente 2 hijos
*/
...
int main()
{
      ...
      //ENCABEZADO
      printf("\nTP3 - Ejercicio 15d");
      printf("\nContar nodos con exactamente 2 hijos");
      printf("\n---------------------------------");
      printf("\n\n");
      ...
      if(miABB != NULL)
      {
          ...
          printf("\nEl ABB contiene %i nodo/s, de los cuales %i tiene/n exactamente 2 hijos.\n", res2, res);
      }
      else
      {
...
/*Pos      : 
/*--------------------------------------------------------------*/
int verificarDosHijo (TApNodoArbolBinario a)
{
    //VARIABLES
    int res;
    res = 0;
