    ...
    Public Function get_all_by_filtros(ByVal cd_curso As Int32, ByVal cd_alumno As Int32, ByVal nombre_alumno As String, ByVal apellido_alumno As String) As List(Of Entidades.ActaCursada)
        Using cnn As SqlConnection = CreateConnection()
            ...
            Using cmd As New SqlCommand
                ...
                cmd.CommandText = "Alumnos.ACTA_CURSADA_SEARCH"
                ...
                Try
                    Using oReader As SqlDataReader = cmd.ExecuteReader
                        Do While oReader.Read
                            ...
                            Dim o_entidades_calificacionCursada As New Entidades.ActaCursada
        ...
        Try
            Using cnn As SqlConnection = CreateConnection()
                ...
                Using cmd As New SqlCommand
                    cmd.Connection = cnn
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.CommandText = "Alumnos.ACTA_CURSADA_INSERT"
                    ...
                    cmd.Parameters.AddWithValue("@base_calificacion", item._base_calificacion)
